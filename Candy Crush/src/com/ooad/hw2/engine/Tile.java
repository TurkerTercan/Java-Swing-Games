    ...
    public Tile(int x, int y, int image_width, int image_height, Color color) {
        ...
        if (color == Color.RED) {
            sprite = new Sprite(x, y, image_width, image_height,
                    new ImageIcon(Objects.requireNonNull(TileManager.class.getResource(Helper.redTilePath))).getImage());
        } else if (color == Color.BLUE) {
            sprite = new Sprite(x, y, image_width, image_height,
                    new ImageIcon(Objects.requireNonNull(TileManager.class.getResource(Helper.blueTilePath))).getImage());
        } else {
            sprite = new Sprite(x, y, image_width, image_height,
                    new ImageIcon(Objects.requireNonNull(TileManager.class.getResource(Helper.greenTilePath))).getImage());
        }
    }
